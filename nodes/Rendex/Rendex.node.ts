	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				description:
					"How often to check, in minutes. The minimum is your plan's floor — Free 1440 (daily), Basic 180, Starter 60, Pro 30, Enterprise 5. A faster value is rejected with WATCH_INTERVAL_TOO_FAST.",
			},
			{
